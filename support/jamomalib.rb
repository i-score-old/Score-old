          ...
          libraries.each do |lib|
            if mac?
              ...
              if (lib == "FOUNDATION")
                ...
                makefile.write("#{path_to_moduleroot}/support/jamoma/lib/JamomaDSP.dylib")
              elsif (lib == "MODULAR")
                makefile.write("#{path_to_moduleroot}/support/jamoma/lib/JamomaModular.dylib")
              elsif (lib == "GRAPH")
                makefile.write("#{path_to_moduleroot}/support/jamoma/lib/JamomaGraph.dylib")
              elsif (lib == "AUDIOGRAPH")
                makefile.write("#{path_to_moduleroot}/support/jamoma/lib/JamomaAudioGraph.dylib")
              elsif (lib == "GRAPHICS")
                makefile.write("#{path_to_moduleroot}/support/jamoma/lib/JamomaGraphics.dylib")
              elsif (lib == "C74")
