...
#ifndef __TT_ENGINE_H__
#define __TT_ENGINE_H__
...
#define PLUGGINS_DEFAULT_LOCATION "/usr/local/lib/IScore"
 ...
 * \class TTEngine
 *
 * \author Théo de la Hogue, based on Engines class written by Raphael Marczak (LaBRI) for the libIscore.
 * \date 2012-2013
 *
